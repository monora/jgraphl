...
public class MutableUndirectedAdjacencyGraphTest {
	...
	public void setUp() throws Exception {
		...
		graphUnderTest = Graphs.toMutableUndirectedAdjacencyGraph(cycle);
	}
	...
	public void testAddEdge() {
		...
		assertThat("Adding the opposite edge should not increase edge size by one",
				graphUnderTest.noOfEdges(), is(5L));
